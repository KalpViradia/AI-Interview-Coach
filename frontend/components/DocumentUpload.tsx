          ...
          {activeTab === "upload" ? (
            ...
            >
              {!file ? (
                ...
                <div className="border border-zinc-700 bg-zinc-800/30 rounded-2xl p-6">
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-3 text-xs text-zinc-400 mt-1">
                          ...
                          {isLoading ? (
                            <span className="flex items-center gap-1 text-indigo-400"><Loader2 className="w-3 h-3 animate-spin" /> Parsing...</span>
                          ) : (
                            <span className="flex items-center gap-1 text-emerald-400"><CheckCircle2 className="w-3 h-3" /> Ready</span>
                          )}
                        </div>
                      </div>
                    </div>
