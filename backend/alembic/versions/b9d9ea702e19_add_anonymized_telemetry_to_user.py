"""Add anonymized_telemetry to User

Revision ID: b9d9ea702e19
Revises: 468015503c24
Create Date: 2026-07-03 12:08:03.576188
...
revision: str = 'b9d9ea702e19'
down_revision: Union[str, None] = '468015503c24'
...
def upgrade() -> None:
    ...
    op.add_column('users', sa.Column('anonymized_telemetry', sa.Boolean(), nullable=True))
